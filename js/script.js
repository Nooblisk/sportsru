...
for (var i=0; i<obj.length; i++){
    ...
    var href = "<a href='"+obj[i].tag_url+"' title='"+ obj[i].name +"'>"+obj[i].name+"</a>";
    ...
    var lose = "<td class='class2'>"+obj[i].lose+"</td>";
    var goals = "<td class='class1'>"+obj[i].goals+"</td>";
    var conceded_goals = "<td class='class1'>"+obj[i].conceded_goals+"</td>";
    var score = "<td class='color-grey'>"+obj[i].score+"</td>";
